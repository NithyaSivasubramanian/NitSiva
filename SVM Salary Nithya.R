...
library(e1071)
library(ggplot2)
train_sal<-read.csv("C://Users//Data Science//ExcelR//Assignments//Support Vector Machines//SalaryData_Train(1).csv")
test_sal<-read.csv("C://Users//Data Science//ExcelR//Assignments//Support Vector Machines//SalaryData_Test(1).csv")
View(train_sal)
str(train_sal)
